                        ...
                        <div class="col-lg-8" style="border-left:2px solid #e0e0e0;">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <td>
                                            <p><b>Name</b><br><?php echo $_SESSION['liname']; ?>
                                            <p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><b>Email</b><br><?php echo $_SESSION['lemail']; ?>
                                            <p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><b>College</b><br><?php echo strtolower($_SESSION['lcollege']); ?>
                                            <p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><b>Unique ID ( UID )</b><br><?php echo $_SESSION['lid']; ?>
                                            <p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><b>Birthday</b><br><?php echo $_SESSION['lbd']; ?>
                                            <p>
                                        </td>
                                    </tr>
                                </tbody>
